...
📄 **Guide complet pas-à-pas** : [DEPLOY_DIGITALOCEAN.md](./DEPLOY_DIGITALOCEAN.md)

Le guide couvre : création du Droplet, configuration Nginx, pare-feu, transfert des fichiers, DNS, HTTPS (Let's Encrypt) et déploiement automatique via GitHub Actions.
